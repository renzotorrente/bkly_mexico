...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/contacto', ['controller' => 'Contactos', 'action' => 'contacto']);
 /*    $routes->connect('/institucional/:seccion', ['controller' => 'Institucionales', 'action' => 'index'],['_name' => 'secciones-institucional'])->setPass(['seccion']); */
