<style>
    ...
    .contenido-modal .form-biweb-prod {
        padding: 15px;
        background-color: #e1e1d7;
        text-align: center;
    }
    .contenido-modal .form-biweb-prod img{
        max-width: 125px;
        width: 100%;
    }
    ...
    @media screen and (max-width: 550px) {
        ...
        .contenido-modal .biweb-fondo, .contenido-modal .form-biweb-prod {
            flex: 0 0 100%;
            max-width: 100%;
        }
    }
...
<div class="modal" id="biweb-prod">
    <div class="modal-content">
        <div class="modal-body">
            <div class="contenido-modal">
                <div class="col-md-8 biweb-fondo">
                    <?= $this->Html->image('home/modales/fondo_productores.jpg',['style' => 'max-height: 100%;max-width: 100%;'])?>
                </div>
                <div class="col-md-4 form-biweb-produ">
                    <?= $this->Form->create(null,['type' => 'POST','url' => "https://col.berkleyonline.com.ar:8443/BIWeb/servlet/com.berkleycomercial10.binetlogin?2",'id'=>'MAINFORM','target' => '_blank'])?>
                        <div class="row campos">
                            ...
                            <div class="col-md-12">
                                <?= $this->Form->control('vUSERNAME',['id' => 'vUSERNAME','type' => 'text','label' => false,'placeholder' => 'Usuario', 'style' => 'margin-bottom: 10px;']) ?>
                            </div>
                            <div class="col-md-12">
                                <?= $this->Form->control('vUSERPASSWORD',['id' => 'vUSERPASSWORD','type' => 'password','label' => false,'placeholder' => 'Clave','style' => 'margin-bottom: 10px;'])?>
                            </div>
                            <div class="col-md-12">
...
<style>
    .form-biweb-produ {
        background-image: url("<?= $this->Url->image('home/modales/fondo_productores_form.png') ?>");
